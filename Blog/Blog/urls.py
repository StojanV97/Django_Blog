...
from django.contrib.auth import views as auth_views #django sistem za login i logout
...
urlpatterns = [
    ...
    path('profile/',user_views.profile,name='profile'),] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
